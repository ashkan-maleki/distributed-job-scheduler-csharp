...
public class Zarf(ILogger<Zarf> logger, Domain.Worker worker,IWorkerHttpClient workerHttpClient,
    IJobHttpClient jobHttpClient, IDbContextFactory<WorkerDbContext> factory)
{
    public static async Task<Zarf> RegisterAsync(ILogger<Zarf> logger, Domain.Worker worker,IWorkerHttpClient workerHttpClient,
        IJobHttpClient jobHttpClient,IDbContextFactory<WorkerDbContext> factory,
